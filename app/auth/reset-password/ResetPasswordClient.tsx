    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-white mb-2 font-display">Invalid Reset Link</h1>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-white mb-2 font-display">Password Reset Successful!</h1>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      >
        ...
        <div className="mt-6 text-center">
          <button onClick={() => router.push('/auth')} className="text-xs text-gray-500 hover:text-white transition-colors">
            Back to Sign In
          </button>
        </div>
      </motion.div>
