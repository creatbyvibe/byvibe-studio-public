...
export default function FeaturesGrid() {
  return (
    <section id="features" className="relative py-12 md:py-20 px-4 md:px-6 border-b border-border bg-background">
      {/* Ambient Glow Effect */}
      ...
      <div className="max-w-7xl mx-auto relative z-0">
        <div className="mb-12 md:mb-16 border-b border-border pb-8">
          <h2 className="text-2xl md:text-3xl font-semibold text-white mb-3 leading-tight font-display">The Vibe AI System</h2>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="group">
                ...
                <h3 className="text-white font-medium mb-3 font-display">{feature.title}</h3>
