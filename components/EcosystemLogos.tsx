...
export default function EcosystemLogos() {
  // Official colored logos - using official brand colors and designs
  // These logos use company brand colors and should be replaced with official logo images from company websites
  const logos = [
    {
      name: 'OpenAI',
      href: 'https://openai.com',
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#412991">
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 283 64" className="h-6 w-auto" fill="#000000">
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 109 113" className="h-8 w-8">
          <path d="M63.7076 110.284C52.8503 116.311 46.083 112.328 44.267 103.423L25.5875 28.6678C23.7715 19.7633 28.8477 14.2061 39.705 8.17899L55.3995 0L84.2035 15.3148C93.0608 21.3419 99.8281 25.3252 101.644 34.2297L108.531 64.6715C110.347 73.576 105.271 79.1332 94.4132 85.1603L63.7076 110.284Z" fill="#3ECF8E"/>
          <path d="M44.3675 45.1047C43.9852 46.3105 44.2124 47.6138 44.9635 48.6087L60.0159 68.7869C60.767 69.7818 61.9999 70.3012 63.2634 70.1314L82.1208 67.8564C83.3843 67.6866 84.4999 66.8478 85.0665 65.6337L94.5692 43.7273C96.6537 39.4 94.8125 34.1603 90.4852 32.0758C90.4852 32.0758 73.9815 23.3632 66.1842 19.3094C58.3868 15.2556 52.8503 19.7633 52.8503 19.7633C48.523 21.8478 46.6818 27.0875 48.7663 31.4148L44.3675 45.1047Z" fill="#249361"/>
        </svg>
      ),
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 105 35" className="h-6 w-auto" fill="#F38020">
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#181717">
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 272 92" className="h-6 w-auto">
          ...
          <path d="M163.75 47.18c0 12.77-9.99 22.18-22.25 22.18s-22.25-9.41-22.25-22.18c0-12.85 9.99-22.18 22.25-22.18s22.25 9.32 22.25 22.18zm-9.74 0c0-7.98-5.79-13.44-12.51-13.44s-12.51 5.46-12.51 13.44c0 7.9 5.79 13.44 12.51 13.44s12.51-5.55 12.51-13.44z" fill="#34A853"/>
          <path d="M209.75 26.34v39.82c0 16.38-9.66 23.07-21.08 23.07-10.75 0-17.22-7.19-19.66-13.07l8.48-3.53c1.51 3.61 5.21 7.87 11.17 7.87 7.31 0 11.84-4.51 11.84-13v-3.19h-.34c-2.18 2.69-6.38 5.04-11.68 5.04-11.09 0-21.25-9.66-21.25-22.09 0-12.52 10.16-22.26 21.25-22.26 5.29 0 9.49 2.35 11.68 4.96h.34v-3.61h9.25zm-8.56 20.92c0-7.81-5.21-13.52-11.84-13.52-6.94 0-12.35 5.71-12.35 13.52 0 7.73 5.41 13.36 12.35 13.36 6.63 0 11.84-5.63 11.84-13.36z" fill="#FBBC04"/>
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#D4A574">
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#FF6B35">
          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
        </svg>
      ),
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#00B4D8">
          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
        </svg>
      ),
    },
    {
      ...
      logo: (
        <div className="flex items-center gap-1">
          <span className="text-lg font-bold text-black">v0</span>
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#6366F1">
          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
        </svg>
      ),
    },
    ...
    },
    {
      ...
      href: 'https://bolt.new',
      logo: (
        <svg viewBox="0 0 24 24" className="h-8 w-8" fill="#F59E0B">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-6 gap-4 md:gap-5 justify-items-center">
          {logos.map((logo, index) => (
            ...
            >
              <div className="flex items-center justify-center mb-2 h-8 md:h-10 w-full">
                {logo.logo}
              </div>
